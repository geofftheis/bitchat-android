...
object AppConstants {
    ...
    object Mesh {
        ...
        const val CONNECTION_RETRY_DELAY_MS: Long = 2_500L  // Half-Wit Patch 43: Reduced from 5s to 2.5s for faster mesh healing in small games
    ...
    object Power {
        ...
        const val MAX_CONNECTIONS_NORMAL: Int = 10       // Half-Wit Patch 17: was 8, increased for 8-player game + bystanders
        const val MAX_CONNECTIONS_POWER_SAVE: Int = 10  // Half-Wit Patch 17: was 8
